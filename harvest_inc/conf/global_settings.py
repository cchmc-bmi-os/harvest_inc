...
INSTALLED_APPS = (
    ...
    ## The active instance, f.i. ibemc, is added by the local settings file
)
...
# DEBUG and TEMPLATE_DEBUG - see local settings
...
TEMPLATE_CONTEXT_PROCESSORS += (
    ...
    'harvest_inc.context_processors.static',
)
...
ROOT_URLCONF = 'harvest_inc.conf.urls'
...
EMAIL_SUBJECT_PREFIX = '[harvest_inc] '
...
CACHE_MIDDLEWARE_KEY_PREFIX = 'harvest_inc'
...
CSRF_COOKIE_NAME = 'harvest_inc_csrftoken'

# SESSION_COOKIE_AGE = 60 * 20
SESSION_ENGINE = 'django.contrib.sessions.backends.cache'
SESSION_COOKIE_NAME = 'harvest_inc_sessionid'
